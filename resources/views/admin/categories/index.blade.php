    ...
    <table class="table table-striped table-sm">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <div class="d-flex ">
                <a class="btn btn-primary border-0 me-2" href="/dashboard/categories/{{ $category->slug }}"><i class="fa fa-eye" style="font-size:24px"></i></a>
                <a class="btn btn-primary border-0 me-2" href="/dashboard/categories/{{ $category->slug }}/edit"><i class="fa fa-edit" style="font-size:24px"></i></a>
